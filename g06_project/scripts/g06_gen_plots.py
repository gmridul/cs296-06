...
plt.savefig("../plots/g06_plot01.png")
...
ax.set_xlabel("Number of iterations")
ax.set_ylabel("Time(in milliseconds)")
plt.savefig("../plots/g06_plot02.png")
...
ax.set_ylabel("Time(in milliseconds)")
plt.savefig("../plots/g06_plot03.png")
...
ax.set_xlabel("Rerun number")
ax.set_ylabel("Time(in milliseconds)")
plt.savefig("../plots/g06_plot04.png")
...
ax.set_ylabel("Time(in milliseconds)")
plt.savefig("../plots/g06_plot05.png")
...
plt.legend(loc="upper left")
plt.savefig("../plots/g06_plot06.png")
