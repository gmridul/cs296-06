...
namespace cs296
{
	dominos_t::dominos_t()
	{
		...
		ball1_fd.friction = 0.05f; //! No friction to allow the balls to roll freely
		...
		ball2_bd.position.Set (g2_x + g2_l , g2_y + g2_b + r2);
		...
		ball3_fd.friction = 0.05f; //! No friction to allow the balls to roll freely
		...
		ball4_fd.density = 50.0f; //! Set the density to be 20
		ball4_fd.friction = 0.00f; //! No friction to allow the balls to roll freely
		ball4_fd.restitution = 0.00f; //! Zero restitution to allow elastic collision
		...
		ball5_fd.density = 20.0f; //! Set the density to be 5
		...
		ball6_fd.friction = 0.05f; //! No friction to allow the balls to roll freely
		...
		ball8_fd.friction = 0.05f; //! No friction to allow the balls to roll freely
		...
		ball7_fd.friction = 0.05f; //! No friction to allow the balls to roll freely
		...
		b2Body* gear_body;
		 ...
		 ball11_fd.friction = 0.05f; //! No friction to allow the balls to roll freely
